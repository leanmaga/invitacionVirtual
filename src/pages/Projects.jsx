  ...
  return (
    <section className="w-full h-screen relative">
      ...
      <div className="container w-full h-screen flex flex-col items-center justify-center text-center">
        ...
        <button className="rounded-full py-2 px-4 bg-[#10c2ef] text-white font-semibold shadow-md hover:bg-[#262886] ">
      ...
      <img src={calendario} alt="musica" className='w-[50%] h-auto lg:w-[400px] lg:h-[400px]'/>
          ...
          <button className="uppercase m-4 rounded-full py-2 px-4 bg-[#10c2ef] text-white font-semibold shadow-md hover:bg-[#262886] ">
